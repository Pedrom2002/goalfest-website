...
export function AnimatedFeatureCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="group relative rounded-2xl p-6 bg-bg-card border border-[#4ade80]/40 hover:border-[#4ade80] transition-all duration-300 shadow-[0_0_20px_rgba(74,222,128,0.12)] hover:shadow-[0_0_40px_rgba(74,222,128,0.35)]"
    >
