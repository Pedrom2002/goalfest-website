...
export default async function InvitePage({
  ...
  // TODO: remove preview bypass before prod
  if (process.env.NODE_ENV !== "development" && (!invite || invite.archived_at)) notFound();
  if (!invite) {
    return <InviteClient code={code} label={null} expired={false} exhausted={false} />;
  }
  if (invite.archived_at) notFound();
