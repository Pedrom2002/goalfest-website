...
const dictionaries: Record<Lang, Dict> = {
  pt: {
    ...
    "rsvp.fineprint":
      "Os teus dados são usados só para gestão da entrada no Goalfest 2026 (RGPD). Não partilhamos com terceiros. Detalhes em ",
    "rsvp.fineprint.delete": ". Eliminação: ",
  ...
  en: {
    ...
    "rsvp.fineprint":
      "Your data is used only to manage entry to Goalfest 2026 (GDPR). We do not share with third parties. Details at ",
